...
import com.sachin.money_monetary.demo.account.AccountsDao;
...
import com.sachin.money_monetary.demo.products.ProductDao;
import com.sachin.money_monetary.demo.products.Products;
import com.sachin.money_monetary.demo.products.Purchase;
...
public class Services {
    ...
    public List<Purchase> getAllTransaction() {
        try {

            return productDao.getPurchase();
        } catch (Exception ex) {
            logger.error(ex.getLocalizedMessage());
            ex.printStackTrace();
            return null;
